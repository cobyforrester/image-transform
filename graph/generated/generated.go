...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.transformImage":
		if e.complexity.Mutation.TransformImage == nil {
			break
		}

		args, err := ec.field_Mutation_transformImage_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}
...
func (ec *executionContext) _Mutation_transformImage(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
	...
	args, err := ec.field_Mutation_transformImage_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
...
func (ec *executionContext) unmarshalInputImageInstructions(ctx context.Context, obj interface{}) (model.ImageInstructions, error) {
	var it model.ImageInstructions
